...
solution.zip :
	rm -f solution.zip
	zip -9r $@ Makefile Makefile cache.cpp cache.h cacheblock.cpp cacheblock.h cacheconfig.cpp cacheconfig.h cachesimulator.cpp cachesimulator.h counter.h counter.cpp main.cpp memory.cpp memory.h utils.cpp utils.h README.txt
